...
def premium_storefront_text(
    ...
    return (
        f"⭐️ <b>Премиум · {BRAND_NAME}</b>\n\n"
        "Дополнительные возможности для режима малыша:\n\n"
        "• AI-анализ биоритмов\n"
        "• Персональный консультант\n"
        "• Подробные графики сна\n"
        "• Прогноз окон сна\n"
        f"{status}"
        f"{action}\n"
        "\n<i>Стоимость в евро ориентировочная и зависит от платформы.</i>\n"
